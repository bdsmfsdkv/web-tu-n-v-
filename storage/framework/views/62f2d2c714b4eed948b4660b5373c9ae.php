    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">Lịch sử mua tài khoản</h2>
                <p class="text-muted">Xem tất cả lịch sử mua tài khoản game của người dùng</p>
                        ...
                        <table class="table table-hover table-borderless align-middle mb-0 text-nowrap w-100">
                            <thead class="bg-light-subtle text-muted">
                                <tr>
                                    ...
                                    <th class="text-uppercase small">Hành tinh</th>
                                    <th class="text-uppercase small">Kiểu đăng ký</th>
                                    <th class="text-uppercase small">Giá</th>
                                    <th class="text-uppercase small">Thời gian mua</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('admin.users.show', $account->buyer_id)); ?>">
                                                <?php echo e($account->buyer->username ?? 'N/A'); ?>
                                        ...
                                        <td>
                                            <?php if($account->planet === 'earth'): ?>
                                                <span class="badge bg-success">Trái Đất</span>
                                            <?php elseif($account->planet === 'namek'): ?>
                                                <span class="badge bg-lightblue">Namek</span>
                                            <?php elseif($account->planet === 'xayda'): ?>
                                                <span class="badge bg-danger">Xayda</span>
                                            <?php else: ?>
                                                <span class="badge"><?php echo e($account->planet); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if($account->registration_type === 'real'): ?>
                                                <span class="badge bg-success">Thật</span>
                                            <?php else: ?>
                                                <span class="badge bg-warning">Ảo</span>
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e(number_format($account->price)); ?> đ</td>
                                        <td><?php echo e($account->updated_at->format('d/m/Y H:i:s')); ?></td>
                                    </tr>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\history\accounts.blade.php ENDPATH**/ ?>