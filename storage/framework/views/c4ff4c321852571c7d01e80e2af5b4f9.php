...
<div class="modal fade" id="addFlashSaleModal" tabindex="-1" aria-labelledby="addFlashSaleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-3">
            <div class="modal-header border-0 pb-0 pt-4 px-4 bg-light-subtle rounded-top-3">
                <div class="d-flex align-items-center gap-2 flex-grow-1 min-w-0">
                    <span class="flex-shrink-0 text-danger" style="font-size: 1.5rem;"><i class="ti ti-bolt"></i></span>
                    <div class="min-w-0">
                        <h5 class="modal-title fw-bold mb-0" id="addFlashSaleModalLabel">Tạo Flash Sale mới</h5>
                        <p class="text-muted small mb-0 mt-1">Cài đặt chiến dịch giảm giá chớp nhoáng</p>
                    </div>
                </div>
                <button type="button" class="btn-close flex-shrink-0" data-bs-dismiss="modal" aria-label="Đóng"></button>
            </div>
            <form action="<?php echo e(route('admin.flash-sales.store')); ?>" method="POST">
                ...
                <div class="modal-body px-4 pt-3 pb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="campaign_name" class="form-control fw-semibold" placeholder="VD: Flash Sale Cuối Tuần" required>
                    </div>

                    <div class="row mb-3">
                        <div class="col-md-8">
                            <label class="form-label fw-semibold">Thời gian diễn ra <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <input type="datetime-local" name="start_time" class="form-control fw-semibold" required>
                                <span class="input-group-text bg-light-subtle"><i class="ti ti-arrow-right"></i></span>
                                <input type="datetime-local" name="end_time" class="form-control fw-semibold" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Trạng thái <span class="text-danger">*</span></label>
                            <select name="status" class="form-select form-control fw-semibold text-success">
                    ...
                    <h6 class="fw-bold mt-4 mb-3 border-bottom pb-2">Sản phẩm tham gia</h6>
                    
                    <div class="p-3 mb-3 bg-light-subtle rounded-3 border">
                        <div class="row mb-2 d-none d-md-flex">
                            <div class="col-md-4"><label class="form-label fw-semibold mb-0">Sản phẩm <span class="text-danger">*</span></label></div>
                            <div class="col-md-3"><label class="form-label fw-semibold mb-0">Giá cũ <span class="text-danger">*</span></label></div>
                            <div class="col-md-3"><label class="form-label fw-semibold mb-0">Giá Flash Sale <span class="text-danger">*</span></label></div>
                            <div class="col-md-2"></div>
                        </div>

                        <div id="products_container">
                            <!-- Product Row Template -->
                            <div class="row align-items-center product-item mb-3">
                                <div class="col-md-4 mb-2 mb-md-0">
                                    <select name="products[0][id]" class="form-select form-control fw-semibold" required>
                                ...
                                <div class="col-md-3 mb-2 mb-md-0">
                                    <input type="number" name="products[0][old_price]" class="form-control fw-semibold" placeholder="Giá cũ" required min="0">
                                </div>
                                <div class="col-md-3 mb-2 mb-md-0">
                                    <input type="number" name="products[0][new_price]" class="form-control fw-semibold text-danger" placeholder="Giá mới" required min="0">
                                </div>
                                <div class="col-md-2 text-center">
                                    <button type="button" class="btn btn-light-danger btn-sm w-100" onclick="removeProduct(this)">
                        ...
                        <button type="button" class="btn btn-light-primary w-100 fw-semibold border border-dashed mt-2" onclick="addProduct()">
                            <i class="ti ti-plus me-1"></i> Thêm sản phẩm
                        </button>
                    </div>

                </div>
                <div class="modal-footer border-0 bg-light-subtle px-4 py-3 rounded-bottom-3">
                    <button type="button" class="btn btn-secondary fw-semibold" data-bs-dismiss="modal">Hủy</button>
                    <button type="submit" class="btn btn-primary fw-semibold">Xác nhận tạo</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    function addProduct() {
        ...
        const template = `
            <div class="row align-items-center product-item mb-3">
                <div class="col-md-4">
                    <select name="products[${productIndex}][id]" class="form-select form-control fw-semibold" required>
                        <option value="">Chọn sản phẩm</option>
                        <optgroup label="Tài Khoản Game">
                            <?php $__currentLoopData = $allGameCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-3">
                    <input type="number" name="products[${productIndex}][old_price]" class="form-control fw-semibold" placeholder="Giá cũ" required min="0">
                </div>
                <div class="col-md-3">
                    <input type="number" name="products[${productIndex}][new_price]" class="form-control fw-semibold" placeholder="Giá mới" required min="0">
                </div>
                <div class="col-md-2 text-center">
                    <button type="button" class="btn btn-light-danger btn-sm" onclick="removeProduct(this)">
                        <i class="ti ti-trash"></i>
                    </button>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\flash-sales\index.blade.php ENDPATH**/ ?>