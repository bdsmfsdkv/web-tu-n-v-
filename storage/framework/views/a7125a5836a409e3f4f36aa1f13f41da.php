<head>
    ...
    <meta property="og:image" content="<?php echo e(asset(config_get('site_share_image', config_get('site_logo')))); ?>" />
    ...
    <meta name="twitter:image" content="<?php echo e(asset(config_get('site_share_image', config_get('site_logo')))); ?>" />
    <meta name="twitter:image:alt" content="<?php echo e(config_get('site_name')); ?>" />

    <link rel="icon" href="<?php echo e(asset(config_get('site_favicon'))); ?>" type="image/png" />
    <link rel="shortcut icon" href="<?php echo e(asset(config_get('site_favicon'))); ?>" type="image/png" />
    <link rel="apple-touch-icon" href="<?php echo e(asset(config_get('site_favicon'))); ?>" />
...
</head><?php /**PATH C:\xampp\htdocs\resources\views/layouts/user/head.blade.php ENDPATH**/ ?>