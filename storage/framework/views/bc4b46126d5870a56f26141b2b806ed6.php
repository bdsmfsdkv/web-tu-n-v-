                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $luckyWheels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wheel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="<?php echo e(asset($wheel->thumbnail)); ?>" alt="<?php echo e($wheel->name); ?>" style="width: 80px; height: 80px; object-fit: cover;" class="rounded border shadow-sm">
                                        </td>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\admin\lucky-wheels\index.blade.php ENDPATH**/ ?>