...
unset($__errorArgs, $__bag); ?>" placeholder="Nhập tên dịch vụ">
...
unset($__errorArgs, $__bag); ?>">
                                        <option value="gold"
                                            <?php echo e(old('type', $service->type) == 'gold' ? 'selected' : ''); ?>>
                                            Bán vàng</option>
                                        <option value="gem" <?php echo e(old('type', $service->type) == 'gem' ? 'selected' : ''); ?>>
                                            Bán ngọc</option>
                                        <option value="leveling"
                                            <?php echo e(old('type', $service->type) == 'leveling' ? 'selected' : ''); ?>>Cày thuê
                                        </option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-12 d-flex align-items-center mb-3">
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" <?php echo e(old('active', $service->active) == '1' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" rows="4" placeholder="Mô tả chi tiết dịch vụ..."><?php echo e(old('description', $service->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" accept="image/*" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;" onchange="previewImage(this, 'preview-svc-edit-thumb')">
                                        <div class="image-uploads mt-2">
                                            <?php if($service->thumbnail): ?>
                                                <img id="preview-svc-edit-thumb" src="<?php echo e(asset($service->thumbnail)); ?>" alt="img" style="max-height: 80px; object-fit: contain; margin-bottom: 10px; border-radius: 4px;">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-12 mt-3">
                                ...
                                <a href="<?php echo e(route('admin.services.index')); ?>" class="btn btn-secondary">Hủy bỏ</a>
                            </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\admin\services\edit.blade.php ENDPATH**/ ?>