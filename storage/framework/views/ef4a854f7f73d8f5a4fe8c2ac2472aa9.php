                ...
                <?php if($categories->count() > 0): ?>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('random.index', ['slug' => $category->slug])); ?>" class="category__item">
                            <img src="<?php echo e(asset($category->thumbnail)); ?>" alt="<?php echo e($category->name); ?>" class="category__img" />
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\user\random\show-all.blade.php ENDPATH**/ ?>