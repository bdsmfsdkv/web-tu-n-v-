                    ...
                    <div class="detail__images">
                        ...
                        <div class="detail__images-list">
                            ...
                            <a href="<?php echo e($account->thumbnail); ?>" title="Xem ảnh lớn" class="detail__images-link">
                                <img src="<?php echo e(asset($account->thumbnail)); ?>" alt="Tài khoản Random #<?php echo e($account->id); ?>"
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\user\random\detail.blade.php ENDPATH**/ ?>