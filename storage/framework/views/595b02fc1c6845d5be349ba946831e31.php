                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-bolds"><?php echo e($service->name); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="badge <?php echo e($typeClasses[$service->type] ?? ''); ?>">
                                                <?php echo e($typeLabels[$service->type] ?? $service->type); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge <?php echo e($service->active ? 'bg-lightgreen' : 'bg-lightred'); ?>">
                                                <?php echo e($service->active ? 'Hoạt động' : 'Đã ẩn'); ?>

                                            </span>
                                        </td>
                                        <td><?php echo e($service->created_at->format('d/m/Y')); ?></td>
                                        <td>
                                            <a class="me-3" href="<?php echo e(route('admin.services.edit', $service->id)); ?>">
                                                <i class="ti ti-edit fs-5 text-primary"></i>
                                            </a>
                                            <a class="me-3 confirm-delete" href="javascript:void(0);" data-bs-toggle="modal"
                                                data-bs-target="#deleteModal" data-id="<?php echo e($service->id); ?>">
...
<?php $component = App\View\Components\ModalConfirmDelete::resolve(['message' => 'Bạn có chắc chắn muốn xóa dịch vụ game này không? Tất cả dữ liệu có liên quan đến nó sẽ
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views/admin/services/index.blade.php ENDPATH**/ ?>