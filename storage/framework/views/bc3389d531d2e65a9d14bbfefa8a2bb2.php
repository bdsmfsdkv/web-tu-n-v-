<?php $__env->startSection('title', $wheel->name); ?>

<?php $__env->startPush('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/wheel.css')); ?>">
<?php $__env->stopPush(); ?>
    ...
    <div class="container" style="padding-top: 20px; padding-bottom: 40px;">
        ...
        <div class="wheel-header-box">
            <div class="wheel-header-title">
                ...
                <?php echo e(mb_strtoupper($wheel->name)); ?>
                ...
                <div class="main-card">
                    <div class="wheel-arena-wrapper">
                        <div class="wheel-image-container">
                            <img src="<?php echo e(asset($wheel->wheel_image)); ?>" alt="Vòng quay" class="wheel-image">
                        </div>
                        <img src="<?php echo e(asset('assets/images/wheel-pointer.png')); ?>" class="center-pointer-core" id="btnSpinCenterInner" style="object-fit: contain; background: transparent; border-radius: 50%;" onerror="this.src='';">
                    </div>

                    <div class="action-controls">
                        <div class="price-display">
                            <?php echo e(number_format($wheel->price_per_spin)); ?>đ
                        </div>
                        ...
                        <select id="spin-count" class="spin-select">
                            <option value="1" selected>QUAY X 1/ <?php echo e(number_format($wheel->price_per_spin)); ?> 1 LẦN</option>
                            <option value="2">QUAY X 2/ <?php echo e(number_format($wheel->price_per_spin * 2)); ?></option>
                            <option value="3">QUAY X 3/ <?php echo e(number_format($wheel->price_per_spin * 3)); ?></option>
                            <option value="4">QUAY X 4/ <?php echo e(number_format($wheel->price_per_spin * 4)); ?></option>
                            <option value="5">QUAY X 5/ <?php echo e(number_format($wheel->price_per_spin * 5)); ?></option>
                            <option value="10">QUAY X 10/ <?php echo e(number_format($wheel->price_per_spin * 10)); ?></option>
                        </select>
                    ...
                    <div class="inventory-header">
                        ...
                        <div>
                            ...
                            <div class="inventory-amount">
                                ...
                                ?>
                                <span class="user-balance"><?php echo e(number_format(Auth::check() ? Auth::user()->gem : 0)); ?></span> 
                                <span class="inventory-unit"><?php echo e($unitName); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="inventory-buttons">
                        <a href="<?php echo e(route('profile.wheels-history')); ?>" class="btn-history">
                            <i class="fas fa-history"></i> Lịch Sử Quay
                        </a>
                        <a href="<?php echo e(route('profile.withdraw-gem')); ?>" class="btn-withdraw">
                                ...
                                <div class="history-card">
                                    <div class="history-card-left">
                                        ...
                                        <div class="history-info">
                                            <div class="history-name"><?php echo e(Str::limit($item->user->username, 4)); ?>***</div>
                                            <div class="history-reward">
                                                Trúng <?php echo e($item->description); ?><?php echo e($item->spin_count > 1 ? ' x' . $item->spin_count : ''); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const wheelConfig = <?php echo json_encode($wheel->config, 15, 512) ?>;
            ...
            function spinWheel(isTrial) {
                ...
                if (spinCountValue > 10) {
                    ...
                    fetch('<?php echo e(route('lucky.spin', $wheel->slug)); ?>', {
                            method: 'POST',
                            headers: {
            ...
            const username = '<?php echo e(Auth::check() ? Auth::user()->username : "Khách"); ?>';

            // Load local comments
            const wheelSlug = '<?php echo e($wheel->slug); ?>';
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\user\wheel\detail.blade.php ENDPATH**/ ?>