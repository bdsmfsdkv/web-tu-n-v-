...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('title', $news->title)); ?>" placeholder="Nhập tiêu đề tin tức" required>
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="Nhập mô tả ngắn gọn" required><?php echo e(old('description', $news->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" required><?php echo e(old('content', $news->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" accept="image/*" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;" onchange="previewImage(this, 'preview-thumb')">
                                <div class="image-uploads mt-2">
                                    <i class="ti ti-photo-plus text-primary" style="font-size: 40px; display: <?php echo e($news->thumbnail ? 'none' : 'block'); ?>;"></i>
                                    <h5 class="mt-2 mb-0 fw-semibold text-primary"><?php echo e($news->thumbnail ? 'Đổi ảnh đại diện' : 'Kéo thả hoặc click để tải ảnh lên'); ?></h5>
...
unset($__errorArgs, $__bag); ?>
                            <div class="mt-3 text-center bg-light p-2 rounded border" style="min-height: 150px; display: flex; align-items: center; justify-content: center;">
                                <img id="preview-thumb" src="<?php echo e(asset($news->thumbnail)); ?>" alt="Preview Thumbnail" style="max-width: 100%; border-radius: 8px; object-fit: contain; max-height: 200px; display: <?php echo e($news->thumbnail ? 'block' : 'none'); ?>;">
                                <span id="preview-placeholder" class="text-muted" style="display: <?php echo e($news->thumbnail ? 'none' : 'block'); ?>;">Chưa có ảnh được chọn</span>
                            </div>
                        </div>
                        ...
                        <div class="card border border-light-subtle shadow-none mb-3">
                            <div class="card-body p-3">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" <?php echo e(old('active', $news->active) == 1 ? 'checked' : ''); ?>>
