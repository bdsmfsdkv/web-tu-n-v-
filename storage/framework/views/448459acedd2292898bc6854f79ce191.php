            ...
            <div class="ecom-box ecom-info-box">
                ...
                <div class="ecom-actions">
                    <?php if($account->status === 'available'): ?>
                        ...
                        <a href="<?php echo e(route('profile.deposit-atm')); ?>" class="ecom-btn ecom-btn-atm" style="margin-top: 10px; width: 100%; background: #0bcfa5ffff; border-color: #0bcfa5ffff; color: white; text-decoration: none;">
            ...
            <div class="modal__footer">
                <?php if(auth()->guard()->check()): ?>
                    <?php if(Auth::user()->balance < $account->price): ?>
                        ...
                        <a class="modal__btn modal__btn--wallet" href="<?php echo e(route('profile.deposit-atm')); ?>"><i class="fas fa-university"></i> NẠP ATM</a>
                    <?php else: ?>
    ...
    <div id="installmentModal" class="modal-modern">
        <div class="modal__content">
            ...
            <div class="modal__footer">
                <?php if(auth()->guard()->check()): ?>
                    <?php if(Auth::user()->balance < ($account->price * 0.2)): ?>
                        <a class="modal__btn modal__btn--wallet" href="<?php echo e(route('profile.deposit-atm')); ?>"><i class="fas fa-university"></i> NẠP THÊM TIỀN</a>
                    <?php else: ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function showRechargeModal(type) {
                window.location.href = '<?php echo e(route('profile.deposit-atm')); ?>';
            }
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\user\account\detail.blade.php ENDPATH**/ ?>