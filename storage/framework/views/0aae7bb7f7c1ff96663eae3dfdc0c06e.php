        ...
        <div class="grid-layout">
            ...
            <div class="col-left">
                <div class="card-custom">
                    ...
                    <form action="<?php echo e(route('profile.deposit-usdt')); ?>" method="POST" id="usdtForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="info-box-custom">
                            <div style="font-size: 0.95rem;">Tỷ giá quy đổi: <strong style="color: #dc2626;">1 USDT = <?php echo e(number_format($rate)); ?> VND</strong></div>
                    ...
                    <table class="custom-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td style="font-weight: 600; color: #dc2626;"><?php echo e($transaction->request_code); ?></td>
                                    <td>
                                        <div style="font-weight: 700; color: #059669;"><?php echo e(number_format($transaction->usdt_amount, 2)); ?> USDT</div>
                                        <div style="font-size: 0.8rem; color: #6b7280; margin-top: 4px;">≈ <?php echo e(number_format($transaction->vnd_amount)); ?> VND</div>
                                    </td>
                                    <td style="color: #6b7280;"><?php echo e(number_format($transaction->exchange_rate)); ?> <span style="font-size: 0.8rem;">VND/USDT</span></td>
                                    <td style="color: #4b5563;"><?php echo e($transaction->created_at->format('H:i d/m/Y')); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <?php if($transaction->status === 'pending'): ?>
                                            <button class="btn-pay view-payment" data-code="<?php echo e($transaction->request_code); ?>" data-amount="<?php echo e($transaction->usdt_amount); ?>">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="mobile-card">
                            <div class="mobile-card-row">
                                <strong style="color: #dc2626; font-size: 0.95rem;"><?php echo e($transaction->request_code); ?></strong>
                                <?php if($transaction->status === 'pending'): ?>
                                    <span class="badge-custom badge-pending">Chờ thanh toán</span>
                                <?php elseif($transaction->status === 'completed'): ?>
                                    <span class="badge-custom badge-success">Thành công</span>
                            ...
                            <div class="mobile-card-row">
                                ...
                                <strong style="color: #059669;"><?php echo e(number_format($transaction->usdt_amount, 2)); ?> USDT</strong>
                            </div>
                            <div class="mobile-card-row">
                                <span style="color: #6b7280;">Thực nhận:</span>
                                <strong>≈ <?php echo e(number_format($transaction->vnd_amount)); ?> VND</strong>
                            </div>
                            <div class="mobile-card-row">
                                <span style="color: #6b7280;">Tỷ giá:</span>
                                <span style="color: #4b5563;"><?php echo e(number_format($transaction->exchange_rate)); ?></span>
                            </div>
                            <div class="mobile-card-row border-top">
                                <span style="color: #6b7280; font-size: 0.8rem;"><?php echo e($transaction->created_at->format('H:i d/m/Y')); ?></span>
                                <?php if($transaction->status === 'pending'): ?>
                                    <button class="btn-pay view-payment" data-code="<?php echo e($transaction->request_code); ?>" data-amount="<?php echo e($transaction->usdt_amount); ?>">
                                        <i class="fa-solid fa-qrcode"></i> Thanh toán
                                    </button>
        ...
        <div style="margin-bottom: 20px;">
            ...
            <div class="input-group-custom" style="border-radius: 8px;">
                <select id="modal-network" class="input-custom" style="padding: 10px; cursor: pointer;">
                    <?php $__currentLoopData = $usdtAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($acc->wallet_address); ?>" data-type="<?php echo e($acc->type); ?>" data-qr="<?php echo e($acc->qr_image); ?>"><?php echo e($acc->name); ?> (<?php echo e(strtoupper($acc->type)); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if($usdtAccounts->isEmpty()): ?>
...
<?php if(session('auto_show_modal')): ?>
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const autoShowData = <?php echo json_encode(session('auto_show_modal'), 15, 512) ?>;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        viewBtns.forEach(btn => {
            btn.addEventListener('click', function(e) {
                ...
                const displayCode = 'Nap<?php echo e(Auth::id()); ?>';
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views/user/profile/deposit-usdt.blade.php ENDPATH**/ ?>