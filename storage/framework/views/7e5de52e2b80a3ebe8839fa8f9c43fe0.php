                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <?php if($rewardItem->icon): ?>
                                    <div class="mb-2">
                                        <img src="<?php echo e($rewardItem->icon); ?>" alt="Icon" class="rounded border shadow-sm" style="width: 80px; height: 80px; object-fit: contain;">
                                    </div>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\reward-items\edit.blade.php ENDPATH**/ ?>