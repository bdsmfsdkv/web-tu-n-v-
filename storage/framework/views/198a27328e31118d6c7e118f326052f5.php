    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                ...
                <div class="page-btn">
                    <a href="<?php echo e(route('admin.bank-accounts.create')); ?>" class="btn btn-success">
                ...
                <form class="p-3 bg-auto-subtle border-bottom filter-form" method="GET">
                    ...
                    <div class="table-responsive table-border-style">
                        <table class="table table-hover table-borderless align-middle mb-0 text-nowrap w-100">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $bankAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($key + 1); ?></td>
                                        <td>
                                            <?php if($account->image): ?>
                                                <img src="<?php echo e(asset($account->image)); ?>" alt="<?php echo e($account->bank_name); ?>" style="width: 30px; height: 30px; object-fit: contain; margin-right: 8px; border-radius: 4px; border: 1px solid #eee;">
                                            <?php endif; ?>
                                            <?php echo e($account->bank_name); ?>

                                        </td>
                                        <td><?php echo e($account->account_number); ?></td>
                                        <td><?php echo e($account->branch ?? 'Không có'); ?></td>
                                        <td><?php echo e($account->prefix); ?></td>
                                        <td title="<?php echo e($account->access_token); ?>">
                                            <?php echo e(Str::limit($account->access_token, 15, '...')); ?>
                                        ...
                                        <td class="text-end">
                                            <a class="me-3" href="<?php echo e(route('admin.bank-accounts.edit', $account->id)); ?>">
...
<?php $component = App\View\Components\ModalConfirmDelete::resolve(['message' => ' Bạn có chắc chắn muốn xóa tài khoản ngân hàng này không? Tất cả dữ liệu có liên quan đến nó sẽ
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\bank-accounts\index.blade.php ENDPATH**/ ?>