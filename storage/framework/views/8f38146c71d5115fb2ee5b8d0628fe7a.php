    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                ...
                <div class="page-btn">
                    <a href="<?php echo e(route('admin.settings.notifications.create')); ?>" class="btn btn-success">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <code><?php echo e($notification->class_favicon); ?></code>
                                        </td>
                                        <td><?php echo e($notification->content); ?></td>
                                        <td><?php echo e($notification->created_at->format('d/m/Y H:i')); ?></td>
                                        <td class="text-end">
                                            <a class="me-3"
                                                href="<?php echo e(route('admin.settings.notifications.edit', $notification->id)); ?>">
                                                <i class="ti ti-edit fs-5 text-primary"></i>
                                            </a>
                                            <a class="me-3" href="javascript:void(0);"
                                                onclick="showDeleteModal(<?php echo e($notification->id); ?>)">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        function showDeleteModal(id) {
            $('#delete-form').attr('action', '<?php echo e(route('admin.settings.notifications.destroy', ':id')); ?>'.replace(':id',
                id));
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views/admin/settings/notifications.blade.php ENDPATH**/ ?>