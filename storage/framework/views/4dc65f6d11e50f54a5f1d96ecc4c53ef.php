    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">Danh sách tài khoản random</h2>
                <p class="text-muted">Quản lý tài khoản random</p>
            
            </div>
        </div></div>
</div>
                <div class="page-btn">
                    <a href="<?php echo e(route('admin.random-accounts.create')); ?>" class="btn btn-success">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('admin.random-categories.edit', ['category' => $account->category->id])); ?>"
                                                target="_blank">
                                                <?php echo e($account->category->name); ?>

                                            </a>
                                        </td>

                                        </td>
                                        <td><?php echo e($account->server); ?></td>
                                        <td><?php echo e(number_format($account->price)); ?></td>
                                        <td><span
                                                class="badge <?php echo e($account->status === 'available' ? 'bg-lightgreen' : 'bg-lightred'); ?>"><?php echo e($account->status === 'available' ? 'Chưa bán' : 'Đã bán'); ?></span>
                                        </td>
                                        <td><?php echo e($account->buyer ? $account->buyer->name : 'Chưa có'); ?></td>
                                        <td><?php echo e($account->created_at->format('d/m/Y')); ?></td>
                                        <td class="text-center">
                                            <a class="me-3"
                                                href="<?php echo e(route('admin.random-accounts.edit', $account->id)); ?>">
                                                <i class="ti ti-edit fs-5 text-primary"></i>
                                            </a>
                                            <a class="me-3 confirm-delete" href="javascript:void(0);"
                                                onclick="showDeleteModal(<?php echo e($account->id); ?>)">
...
<?php $component = App\View\Components\ModalConfirmDelete::resolve(['message' => 'Bạn có chắc chắn muốn xóa tài khoản random này không? Tất cả dữ liệu có liên quan đến nó sẽ
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#confirmDelete').on('click', function() {
                $.ajax({
                    url: "<?php echo e(route('admin.random-accounts.destroy', ':id')); ?>".replace(':id',
                        accountId),
                    type: 'DELETE',
                    data: {
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views/admin/random-accounts/index.blade.php ENDPATH**/ ?>