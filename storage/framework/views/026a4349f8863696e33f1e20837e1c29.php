<nav class="pc-sidebar">
    ...
    <img src="<?php echo e(asset(config_get('site_logo'))); ?>"
         alt="Logo"
         style="height: 50px; width: auto; object-fit: contain;">
    <?php else: ?>
    <span class="fw-bold text-white fs-4"><?php echo e(config_get('site_name', 'Admin')); ?></span>
    <?php endif; ?>
</a>
        </div>
            ...
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu <?php echo e(request()->is('admin/history*') ? 'active pc-trigger' : ''); ?>">
                    ...
                    <ul class="pc-submenu" style="display: <?php echo e(request()->is('admin/history*') ? 'block' : 'none'); ?>;">
                        ...
                        <li class="pc-item"><a class="pc-link" href="<?php echo e(route('admin.history.deposits.usdt')); ?>">Nạp USDT</a></li>
                ...
                <li class="pc-item <?php echo e(request()->routeIs('admin.usdt-accounts.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.usdt-accounts.index')); ?>" class="pc-link">
...
<?php /**PATH C:\xampp\htdocs\resources\views/layouts/admin/sidebar.blade.php ENDPATH**/ ?>