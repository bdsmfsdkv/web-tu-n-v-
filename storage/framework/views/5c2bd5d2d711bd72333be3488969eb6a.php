                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('admin.users.show', $service->user_id)); ?>">
                                                <?php echo e($service->user->username ?? 'N/A'); ?>

                                            </a>
                                        </td>
                                        <td>
                                            <?php if($service->gameService): ?>
                                                <?php echo e($service->gameService->name); ?>
                                        ...
                                        <td>
                                            <?php if($service->servicePackage): ?>
                                                <?php echo e($service->servicePackage->name); ?>

                                            <?php else: ?>
                                                <span class="text-danger">Không có</span>
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($service->server); ?></td>
                                        <td><?php echo e($service->game_account); ?></td>
                                        <td><?php echo e(number_format($service->price)); ?> đ</td>
                                        <td>
                                            <?php if($service->status === 'completed'): ?>
                                                <span class="badge bg-success">Hoàn thành</span>
                                            <?php elseif($service->status === 'processing'): ?>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\history\services.blade.php ENDPATH**/ ?>