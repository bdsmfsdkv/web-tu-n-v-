    ...
    <div class="ecom-layout">
        ...
        <div class="ecom-left">
            ...
            <div class="ecom-box ecom-gallery-box">
                <div class="ecom-gallery-inner">
                    ...
                    <div class="ecom-thumbs-vertical">
                        <?php $__currentLoopData = array_slice($images, 0, 8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <img src="<?php echo e($image); ?>" class="ecom-thumb" onclick="changeMainImage('<?php echo e($image); ?>')" alt="Thumb">
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <!-- Main Image -->
                    <div class="ecom-main-img-wrapper">
            ...
            <div class="ecom-box ecom-all-images-box" style="margin-top: 20px; border-color: transparent;">
                ...
                <div class="ecom-all-images-grid">
                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($image); ?>" class="detail__images-link">
                            <img src="<?php echo e($image); ?>" class="ecom-grid-img" alt="Hình ảnh tài khoản">
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
