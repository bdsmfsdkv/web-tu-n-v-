...
<body style="min-height:100vh;display:flex;flex-direction:column;margin:0;">
    ...
    <div id="depositMethodModal" style="display:none;position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.6);z-index:10000;align-items:flex-end;justify-content:center;backdrop-filter:blur(4px);" onclick="if(event.target===this)this.style.display='none'">
        <div class="deposit-modal-content" style="border-radius:16px 16px 0 0;padding:24px 20px 32px;width:100%;max-width:480px;animation:slideUpModal .25s ease-out;">
            ...
            <div style="display:flex;flex-direction:column;gap:10px;">
                ...
                <a href="<?php echo e(route('profile.deposit-usdt')); ?>" class="deposit-modal-link" style="display:flex;align-items:center;gap:14px;padding:16px;border-radius:12px;border:1px solid #e5e7eb;text-decoration:none;transition:all .2s;">
    ...
    <div class="floating-support">
        <a href="https://zalo.me/<?php echo e(config_get('zalo', '0123456789')); ?>" target="_blank" rel="noopener noreferrer" class="support-item zalo" title="Hỗ trợ Zalo" aria-label="Hỗ trợ Zalo">
            <img src="https://shopaccgamev2.tuanori.vn/images/zalo.webp" alt="Zalo">
            <span class="support-text">Chat Zalo</span>
        </a>
        <a href="<?php echo e(config_get('facebook', 'https://facebook.com')); ?>" target="_blank" rel="noopener noreferrer" class="support-item messenger" title="Hỗ trợ Facebook" aria-label="Hỗ trợ Facebook">
...
<?php /**PATH C:\xampp\htdocs\resources\views/layouts/user/app.blade.php ENDPATH**/ ?>