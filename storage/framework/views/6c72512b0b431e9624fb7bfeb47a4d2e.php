...
<div class="container" style="margin-top: 30px; margin-bottom: 40px;">
    ...
    <?php if(isset($purchases) && $purchases->hasPages()): ?>
        <div style="margin-top: 30px;">
            <?php echo e($purchases->links('user.pagination.custom')); ?>
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\user\reviews.blade.php ENDPATH**/ ?>