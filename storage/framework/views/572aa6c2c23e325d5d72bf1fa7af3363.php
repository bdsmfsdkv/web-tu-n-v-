                    ...
                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($service->active): ?>
                            <a href="<?php echo e(route('service.show', ['slug' => $service->slug])); ?>" class="category__item">
                                <img src="<?php echo e($service->thumbnail); ?>" alt="<?php echo e($service->name); ?>" class="category__img" />
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\user\service\show-all.blade.php ENDPATH**/ ?>