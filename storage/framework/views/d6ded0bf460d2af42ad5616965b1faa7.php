                            ...
                            <div class="info-content">
                                ...
                                <div class="transaction-history">
                                    <style>
                                        ...
                                        .r-order-id { width: 60px; height: 40px; background: #ef4444; color: #fff; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 0.95rem; margin-right: 16px; flex-shrink: 0; }
                                        .r-order-info { flex: 1; }
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <a href="<?php echo e(route('profile.purchased-random-account-detail', $order->order_batch_id)); ?>" class="random-order-card">
                                            <div class="r-order-id">
                                                #<?php echo e(str_replace('ORD-', '', str_replace('LEGACY-', '', $order->order_batch_id))); ?>
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\user\profile\purchased-random-accounts.blade.php ENDPATH**/ ?>