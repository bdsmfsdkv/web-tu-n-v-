...
unset($__errorArgs, $__bag); ?>" placeholder="Nhập tên danh mục sản phẩm">
...
unset($__errorArgs, $__bag); ?>" accept="image/*" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;" onchange="previewImage(this, 'preview-cat-thumb')">
...
unset($__errorArgs, $__bag); ?>" accept="image/*" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;" onchange="previewImage(this, 'preview-cat-tag')">
                                        <div class="image-uploads mt-2">
...
unset($__errorArgs, $__bag); ?>" rows="4" placeholder="Nhập mô tả chi tiết danh mục"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\admin\categories\create.blade.php ENDPATH**/ ?>