...
<?php $__env->startSection('title', 'Lịch sử mua trả góp'); ?>
        ...
        <div class="profile-main" style="flex: 1;">
            <div class="card" style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 12px; padding: 24px;">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $installments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $installment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr style="border-bottom: 1px solid var(--border-color); color: var(--text-color);">
                                    <td style="padding: 12px; font-weight: 600;">#<?php echo e($installment->id); ?></td>
                                    <td style="padding: 12px;">
                                        <a href="<?php echo e(route('account.show', $installment->game_account_id)); ?>" style="color: var(--primary); text-decoration: underline;">
                                            Nick #<?php echo e($installment->game_account_id); ?>

                                        </a>
                                    </td>
                                    <td style="padding: 12px; font-weight: 600;"><?php echo e(number_format($installment->total_price)); ?>đ</td>
                                    <td style="padding: 12px; color: #10b981;"><?php echo e(number_format($installment->paid_amount)); ?>đ</td>
                                    <td style="padding: 12px; color: #ef4444;"><?php echo e(number_format($remaining)); ?>đ</td>
                                    <td style="padding: 12px; <?php echo e($isOverdue ? 'color: #ef4444; font-weight: bold;' : ''); ?>">
                                        <?php echo e($installment->expire_date->format('d/m/Y H:i')); ?>

                                        <?php if($isOverdue): ?> <br><small>(Quá hạn)</small> <?php endif; ?>
                                    </td>
                                    <td style="padding: 12px;">
                                    ...
                                    <td style="padding: 12px;">
                                        <?php if($installment->status === 'active' && !$isOverdue && $remaining > 0): ?>
                                            <button onclick="openPayModal(<?php echo e($installment->id); ?>, <?php echo e($remaining); ?>)" style="background: var(--primary); color: white; border: none; padding: 6px 12px; border-radius: 4px; cursor: pointer; font-size: 0.85rem; font-weight: 600;">Thanh toán</button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                ...
                <div style="margin-top: 24px; display: flex; justify-content: center;">
                    <?php echo e($installments->links('user.pagination.custom')); ?>
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views/user/profile/installments.blade.php ENDPATH**/ ?>