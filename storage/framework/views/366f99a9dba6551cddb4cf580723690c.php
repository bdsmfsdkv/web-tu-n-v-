        ...
        <div class="col-md-12">
            ...
            <div class="card overflow-hidden shadow-sm border border-dashed">
                <div class="card-body px-0 py-0">
                    <form class="p-3 bg-auto-subtle border-bottom" action="<?php echo e(route('admin.users.index')); ?>" method="GET">
                        <div class="row align-items-center g-2">
                            ...
                            <div class="col-md-3">
                                <input type="text" name="search" class="form-control form-control-sm" placeholder="Tìm kiếm username, email, ip..." value="<?php echo e(request('search')); ?>">
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-3 d-flex gap-2">
                                ...
                                <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-sm btn-light-danger w-100">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-center">
                                            <div class="form-check m-0 d-flex justify-content-center">
                                                <input class="form-check-input" type="checkbox" value="<?php echo e($user->id); ?>">
                                            </div>
                                        </td>
                                        <td><span class="text-muted"><?php echo e($user->id); ?></span></td>
                                        <td><span class="fw-medium text-primary"><?php echo e($user->username); ?></span></td>
                                        ...
                                        <td><span class="fw-semibold text-success"><?php echo e(number_format($user->balance)); ?>đ</span></td>
                                        <td><span class="fw-medium"><?php echo e(number_format($user->total_deposited)); ?>đ</span></td>
                                        <td>
                                            <?php if($user->banned): ?>
                                        ...
                                        <td><span class="text-muted small"><?php echo e($user->ip_address); ?></span></td>
                                        <td><span class="text-muted small"><?php echo e($user->created_at->format('d/m/Y')); ?></span></td>
                                        <td class="text-center">
                                            <a class="me-2 text-primary" href="<?php echo e(route('admin.users.show', $user->id)); ?>">
                                                <i class="ti ti-edit fs-5"></i>
                                            </a>
                                            <a class="text-danger confirm-delete" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?php echo e($user->id); ?>">
...
<?php $component = App\View\Components\ModalConfirmDelete::resolve(['message' => 'Bạn có chắc chắn muốn xóa người dùng này không? Tất cả dữ liệu có liên quan đến nó sẽ
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views/admin/users/index.blade.php ENDPATH**/ ?>