...
unset($__errorArgs, $__bag); ?>" accept="image/*" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;" onchange="previewImage(this, 'preview-cat-edit-thumb')">
                                        <div class="image-uploads mt-2">
                                            <?php if($category->thumbnail): ?>
                                                <img id="preview-cat-edit-thumb" src="<?php echo e(asset($category->thumbnail)); ?>" alt="img" style="max-height: 80px; object-fit: contain; margin-bottom: 10px; border-radius: 4px;">
...
unset($__errorArgs, $__bag); ?>" accept="image/*" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;" onchange="previewImage(this, 'preview-cat-edit-tag')">
                                        <div class="image-uploads mt-2">
                                            <?php if($category->tag_image): ?>
                                                <img id="preview-cat-edit-tag" src="<?php echo e(asset($category->tag_image)); ?>" alt="img" style="max-height: 50px; object-fit: contain; margin-bottom: 10px; border-radius: 4px;">
...
unset($__errorArgs, $__bag); ?>" rows="4" placeholder="Nhập mô tả chi tiết danh mục"><?php echo e(old('description', $category->description)); ?></textarea>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\admin\categories\edit.blade.php ENDPATH**/ ?>