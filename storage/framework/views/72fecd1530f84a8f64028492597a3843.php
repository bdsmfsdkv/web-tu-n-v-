...
<nav class="navbar">
    <div class="nav-container">
        <a href="/" class="nav-brand">
            <img src="<?php echo e(config_get('site_logo')); ?>" alt="<?php echo e(config_get('site_name')); ?>" style="height:32px;">
        </a>
        ...
        <ul class="nav-links" id="navLinks">
            <li class="nav-offcanvas-header">
                <a href="/" class="nav-brand">
                    <img src="<?php echo e(config_get('site_logo')); ?>" alt="<?php echo e(config_get('site_name')); ?>" style="height:28px;">
                </a>
                <button class="nav-close" id="navClose" onclick="closeNav()">
        ...
        <div class="nav-user">
            ...
            <button class="theme-toggle" id="themeToggle" title="Chuyển giao diện">
            ...
            <div class="nav-avatar-wrapper" id="avatarWrapper">
                <div class="nav-user-profile" onclick="toggleAvatarMenu()"
                    ...
                    <button class="nav-avatar" id="avatarBtn">
