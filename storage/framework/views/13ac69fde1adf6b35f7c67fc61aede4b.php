    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">Cài đặt Email</h2>
                <p class="text-muted">Cấu hình email server và thông báo</p>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\settings\email.blade.php ENDPATH**/ ?>