        ...
        <!-- [Mobile Media Block end] -->
                ...
                <li class="dropdown pc-h-item header-user-profile">
                    <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" data-bs-auto-close="outside" aria-expanded="false">
                        <img src="<?php echo e(asset('assets/img/profiles/avator1.jpg')); ?>" alt="user-image" class="user-avtar" />
                    </a>
                        ...
                        <div class="dropdown-body">
                            <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px);">
                                <div class="d-flex mb-1">
                                    <div class="flex-shrink-0"><img src="<?php echo e(asset('assets/img/profiles/avator1.jpg')); ?>" alt="user-image" class="user-avtar wid-35" /></div>
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1"><?php echo e(auth()->user()->username ?? 'Admin'); ?></h6>
                                    </div>
                                </div>
...
<?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\layouts\admin\header.blade.php ENDPATH**/ ?>