            ...
            <div class="card" style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 12px; padding: 24px;">
                <div style="display: flex; gap: 24px; flex-wrap: wrap;">
                    <div style="flex: 0 0 auto; width: 260px; max-width: 100%;">
                        <img src="<?php echo e($category->thumbnail ?? 'https://via.placeholder.com/300x180'); ?>" alt="<?php echo e($category->name); ?>" style="width: 100%; border-radius: 12px; object-fit: cover; border: 1px solid var(--border-color);">
                    </div>
        ...
        <div style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 16px; width: 100%; max-width: 480px; animation: modalPop 0.2s ease-out; display: flex; flex-direction: column;">
            ...
            <div style="padding: 24px;">
                <div style="display: flex; gap: 16px; background: rgba(0,0,0,0.2); padding: 16px; border-radius: 12px; margin-bottom: 24px; border: 1px solid var(--border-color);">
                    <img src="<?php echo e($category->thumbnail ?? 'https://via.placeholder.com/150'); ?>" style="width: 60px; height: 60px; border-radius: 8px; object-fit: cover;">
                ...
                <div style="margin-bottom: 24px;">
                    ...
                    <div style="display: flex; gap: 10px;">
                        ...
                        <input type="number" id="purchaseQuantity" value="1" min="1" max="<?php echo e(min(20, $availableCount)); ?>" onchange="updateTotalPrice()" style="width: 80px; height: 44px; text-align: center; border-radius: 8px; border: 1px solid var(--border-color); background: rgba(0,0,0,0.2); color: var(--text-color); font-weight: 600; font-size: 1.1rem; outline: none;">
                        <button onclick="changeQuantity(1)" style="width: 44px; height: 44px; border-radius: 8px; border: 1px solid var(--border-color); background: rgba(0,0,0,0.2); color: var(--text-color); font-size: 1.2rem; cursor: pointer; display: flex; align-items: center; justify-content: center;">+</button>
                    </div>
                </div>
...
<script>
    ...
    const maxQty = <?php echo e(min(20, $availableCount)); ?>;
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\user\random\category.blade.php ENDPATH**/ ?>