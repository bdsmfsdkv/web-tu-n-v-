        ...
        <div class="withdraw-layout">
            ...
            <div class="withdraw-card">
                ...
                <div class="items-grid">
                    <?php $__currentLoopData = $rewardItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div class="item-card" onclick="selectItem(<?php echo e($item->id); ?>, '<?php echo e($item->name); ?>', <?php echo e($balance); ?>, <?php echo e($item->min_withdraw); ?>, <?php echo e($item->max_withdraw); ?>)" id="item-card-<?php echo e($item->id); ?>">
                            <img src="<?php echo e($item->icon ? asset($item->icon) : asset('assets/images/gem.png')); ?>" class="item-icon" onerror="this.src='https://i.imgur.com/NpL6V6y.png'">
                            <div class="item-name"><?php echo e($item->name); ?></div>
                            <div class="item-balance"><?php echo e(number_format($balance)); ?></div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    
                    <?php if($rewardItems->count() == 0): ?>
                ...
                <div class="withdraw-form" id="withdraw-form">
                    <form action="<?php echo e(route('profile.withdraw-gem')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
            ...
            <div>
                <div class="notes-card">
                    ...
                    <a href="<?php echo e(route('profile.wheels-history')); ?>" class="btn-history-outline">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $withdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr style="border-bottom: 1px solid var(--border-subtle, #e5e7eb); transition: background 0.15s;" onmouseover="this.style.background='rgba(59,130,246,0.03)'" onmouseout="this.style.background='transparent'">
                                    <td style="padding: 14px 20px; color: var(--text-muted, #6b7280); font-size: 0.82rem;"><?php echo e($w->created_at->format('H:i d/m/Y')); ?></td>
                                    <td style="padding: 14px 20px; font-weight: 700; color: var(--text-main, #1f2937);"><?php echo e(number_format($w->amount)); ?></td>
                                    <td style="padding: 14px 20px; color: var(--text-main, #1f2937);"><?php echo e($w->character_name); ?></td>
                                    <td style="padding: 14px 20px; color: var(--text-muted, #6b7280);"><?php echo e($w->user_note ?: '—'); ?></td>
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views/user/profile/withdraw-gem.blade.php ENDPATH**/ ?>