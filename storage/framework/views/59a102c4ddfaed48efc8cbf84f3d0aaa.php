    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">DANH SÁCH GÓI DỊCH VỤ</h2>
                <p class="text-muted">Quản lý gói dịch vụ của bạn</p>
                ...
                <div class="page-btn">
                    <?php if(isset($serviceId)): ?>
                        <a href="<?php echo e(route('admin.packages.createForService', $serviceId)); ?>" class="btn btn-success">
                            <i class="ti ti-plus me-1"></i>Thêm gói dịch vụ mới
                        </a>
                    <?php else: ?>
                        ...
                        <table class="table table-hover table-borderless align-middle mb-0 text-nowrap w-100">
                            <thead class="bg-light-subtle text-muted">
                                <tr>
                                    ...
                                    <th class="text-uppercase small">Tên gói</th>
                                    <th class="text-uppercase small">Dịch vụ</th>
                                    <th class="text-uppercase small">Giá</th>
                                    <th class="text-uppercase small">Thời gian ước tính</th>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-bolds"><?php echo e($package->name); ?></td>
                                        <td>
                                            <a href="<?php echo e(route('admin.services.edit', $package->service->id)); ?>">
                                                <?php echo e($package->service->name); ?>

                                            </a>
                                        </td>
                                        <td><?php echo e(number_format($package->price)); ?> đ</td>
                                        <td>
                                            <?php if($package->estimated_time): ?>
                                                <?php echo e($package->estimated_time); ?> phút
                                            <?php else: ?>
                                                -
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <span class="badge <?php echo e($package->active ? 'bg-lightgreen' : 'bg-lightred'); ?>">
                                                <?php echo e($package->active ? 'Hoạt động' : 'Đã ẩn'); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <a class="me-3" href="<?php echo e(route('admin.packages.edit', $package->id)); ?>">
                                                <i class="ti ti-edit fs-5 text-primary"></i>
                                            </a>
                                            <a class="me-3 confirm-delete" href="javascript:void(0);" data-bs-toggle="modal"
                                                data-bs-target="#deleteModal" data-id="<?php echo e($package->id); ?>">
...
<?php $component = App\View\Components\ModalConfirmDelete::resolve(['message' => 'Bạn có chắc chắn muốn xóa gói dịch vụ này không? Tất cả dữ liệu có liên quan đến nó sẽ
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            let packageId;
            let currentServiceId = <?php echo json_encode($serviceId ?? null, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\packages\index.blade.php ENDPATH**/ ?>