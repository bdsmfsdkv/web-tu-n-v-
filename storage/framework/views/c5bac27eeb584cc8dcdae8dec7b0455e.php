...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="price" value="<?php echo e(old('price', $category->price)); ?>"
...
unset($__errorArgs, $__bag); ?>" placeholder="Nhập giá mặc định cho các tài khoản">
                                    <small class="text-muted">Giá này sẽ tự động điền khi thêm tài khoản vào danh mục này.</small>
...
unset($__errorArgs, $__bag); ?>" accept="image/*" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;">
                                        <div class="image-uploads mt-2">
                                            <?php if($category->thumbnail): ?>
                                                <img src="<?php echo e(asset($category->thumbnail)); ?>" alt="img" style="max-height: 80px; object-fit: contain; margin-bottom: 10px; border-radius: 4px;">
...
unset($__errorArgs, $__bag); ?>" accept="image/*" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;">
                                        <div class="image-uploads mt-2">
                                            <?php if($category->tag_image): ?>
                                                <img src="<?php echo e(asset($category->tag_image)); ?>" alt="img" style="max-height: 50px; object-fit: contain; margin-bottom: 10px; border-radius: 4px;">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views/admin/random-categories/edit.blade.php ENDPATH**/ ?>