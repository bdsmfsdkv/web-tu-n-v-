...
unset($__errorArgs, $__bag); ?>">
                                        <option value="member" <?php echo e($user->role == 'member' ? 'selected' : ''); ?>>Người dùng
                                        </option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="balance" value="<?php echo e($user->balance); ?>"
                                        class="form-control <?php $__errorArgs = ['balance'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="total_deposited" value="<?php echo e($user->total_deposited); ?>"
                            ...
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <select name="banned" class="form-select <?php $__errorArgs = ['banned'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <option value="0" <?php echo e($user->banned == 0 ? 'selected' : ''); ?>>Hoạt động
                                        </option>
                                        <option value="1" <?php echo e($user->banned == 1 ? 'selected' : ''); ?>>Bị khóa</option>
                                    </select>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td
                                            class="<?php echo e($transaction->type == 'deposit' || $transaction->type == 'refund' ? 'text-success' : 'text-danger'); ?>">
                                            <?php echo e(($transaction->type == 'deposit' || $transaction->type == 'refund' ? '+' : '') . number_format($transaction->amount)); ?>đ
                                        </td>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>