        ...
        <div class="hero-grid">
                ...
                <div class="top-deposit-panel">
                    ...
                    <div class="panel-body tab-content active" id="tab-top">
                        <?php $__empty_1 = true; $__currentLoopData = $topDepositors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depositor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="top-item">
                                <div class="top-avatar <?php echo e($loop->iteration <= 3 ? 'rank-'.$loop->iteration : ''); ?>"><?php echo e($loop->iteration); ?></div>
                                <div class="top-info">
            ...
            <div class="hero-right">
                <div class="banner-slider" id="bannerSlider">
                    ...
                    <button class="slider-arrow slider-prev" id="sliderPrev"><span class="iconify" data-icon="ant-design:left-outlined"></span></button>
                    <button class="slider-arrow slider-next" id="sliderNext"><span class="iconify" data-icon="ant-design:right-outlined"></span></button>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<div class="announce-overlay" id="announceOverlay" onclick="if(event.target===this)closeAnnounce(false)">
    <div class="announce-modal">
        <div class="announce-header">
            ...
            <button class="announce-close-x" onclick="closeAnnounce(false)">&times;</button>
        </div>
...
<script>
    ...
    function closeAnnounce(silent2h) {
        ...
        function updateTimer() {
            ...
            document.getElementById('fs-days').innerText = days.toString().padStart(2, '0');
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\user\home.blade.php ENDPATH**/ ?>