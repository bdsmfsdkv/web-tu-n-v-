...
unset($__errorArgs, $__bag); ?>" accept="image/*" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;" onchange="previewImage(this, 'preview-ra-edit-thumb')">
                                        <div class="image-uploads mt-2">
                                            <?php if($account->thumbnail): ?>
                                                <img id="preview-ra-edit-thumb" src="<?php echo e(asset($account->thumbnail)); ?>" alt="img" style="max-height: 80px; object-fit: contain; margin-bottom: 10px; border-radius: 4px;">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\admin\random-accounts\edit.blade.php ENDPATH**/ ?>