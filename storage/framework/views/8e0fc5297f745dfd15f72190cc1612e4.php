    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">Lịch sử mua tài khoản Random</h2>
                <p class="text-muted">Xem tất cả lịch sử mua tài khoản random của người dùng</p>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('admin.users.show', $purchase->buyer_id)); ?>">
                                                <?php echo e($purchase->buyer->username ?? 'N/A'); ?>

                                            </a>
                                        </td>
                                        <td>
                                            <a href="<?php echo e(route('admin.random-accounts.edit', $purchase->id)); ?>">
                                                <?php echo e($purchase->account_name ?? 'ACC#' . $purchase->id); ?>

                                            </a>
                                        </td>
                                        <td>
                                            <?php if($purchase->category): ?>
                                                <?php echo e($purchase->category->name); ?>
                                        ...
                                        <td>
                                            <?php echo e($purchase->server ?? 'N/A'); ?>

                                        </td>
                                        <td><?php echo e(number_format($purchase->price)); ?> đ</td>
                                        <td><?php echo e($purchase->updated_at->format('d/m/Y H:i:s')); ?></td>
                                    </tr>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\history\random-accounts.blade.php ENDPATH**/ ?>