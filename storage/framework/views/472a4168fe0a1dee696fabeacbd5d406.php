    ...
    <div class="container">
        <div class="footer-grid" style="display:grid;grid-template-columns:repeat(auto-fit, minmax(200px, 1fr));gap:40px;margin-bottom:40px;">
            ...
            <div class="footer-brand">
                <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
                    <img src="<?php echo e(config_get('site_logo_footer', config_get('site_logo'))); ?>" alt="<?php echo e(config_get('site_name')); ?>" style="height:32px;">
                </div>
            ...
            <div>
                ...
                <div style="display:flex;gap:10px;margin-top:16px;">
                    ...
                    <a href="<?php echo e(config_get('facebook')); ?>" target="_blank" style="color:#1877f2;font-size:1.5rem;"><i class="fab fa-facebook"></i></a>
                    <?php endif; ?>
                    <?php if(config_get('youtube')): ?>
                    <a href="<?php echo e(config_get('youtube')); ?>" target="_blank" style="color:#ff0000;font-size:1.5rem;"><i class="fab fa-youtube"></i></a>
                    <?php endif; ?>
                    <?php if(config_get('telegram')): ?>
                    <a href="<?php echo e(config_get('telegram')); ?>" target="_blank" style="color:#0088cc;font-size:1.5rem;"><i class="fab fa-telegram"></i></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div style="border-top:1px solid #e5e7eb;padding:20px 0;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px;font-size:0.8rem;">
            ...
            <div style="display:flex;align-items:center;gap:8px;">
                Thiết kế bởi <a href="https://cmsbvq.com" style="font-weight:700;color:var(--primary,#dc2626);text-decoration:none;" target="_blank">CMSBVQ.COM</a>
            </div>
        </div>
    </div>
</footer>
