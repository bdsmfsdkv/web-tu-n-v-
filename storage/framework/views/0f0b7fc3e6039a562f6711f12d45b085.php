<?php $__env->startSection('title', 'Quản lý tài khoản game'); ?>
    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">DANH SÁCH TÀI KHOẢN GAME</h2>
                <p class="text-muted">Quản lý tài khoản game của bạn</p>
                ...
                <div class="page-btn">
                    <a href="<?php echo e(route('admin.accounts.create')); ?>" class="btn btn-success">
                        <i class="ti ti-plus me-1"></i>Thêm tài khoản mới
                    </a>
                </div>
            </div>
                        ...
                        <table class="table table-hover table-borderless align-middle mb-0 text-nowrap w-100">
                            <thead class="bg-light-subtle text-muted">
                                <tr>
                                    ...
                                    <th class="text-uppercase small">Tên tài khoản</th>
                                    <th class="text-uppercase small">Giá tiền</th>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="<?php echo e(route('admin.categories.edit', ['category' => $account->category->id])); ?>"><?php echo e($account->category->name); ?></a>
                                        </td>
                                        <td class="text-bolds"><?php echo e($account->account_name); ?></td>
                                        <td><?php echo e(number_format($account->price)); ?> VNĐ</td>
                                        <td>
                                            <span
                                                class="badge <?php echo e($account->status === 'available' ? 'bg-lightgreen' : 'bg-lightred'); ?>">
                                                <?php echo e($account->status === 'available' ? 'Chưa bán' : 'Đã bán'); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <img src="<?php echo e(asset($account->thumb)); ?>" alt="<?php echo e($account->account_name); ?>"
                                                class="img-thumbnail" style="max-width: 100px;">
                                        </td>
                                        <td>
                                            <a class="me-3" href="<?php echo e(route('admin.accounts.edit', $account->id)); ?>">
                                                <i class="ti ti-edit fs-5 text-primary"></i>
                                            </a>
                                            <a class="me-3 confirm-delete" href="javascript:void(0);" data-bs-toggle="modal"
                                                data-bs-target="#deleteModal" data-id="<?php echo e($account->id); ?>">
...
<?php $component = App\View\Components\ModalConfirmDelete::resolve(['message' => 'Bạn có chắc chắn muốn xóa tài khoản game này không? Tất cả dữ liệu có liên quan đến nó sẽ
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\accounts\index.blade.php ENDPATH**/ ?>