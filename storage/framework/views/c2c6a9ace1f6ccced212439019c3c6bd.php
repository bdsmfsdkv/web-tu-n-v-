    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">Lịch sử nạp tiền qua ngân hàng</h2>
                <p class="text-muted">Xem tất cả lịch sử nạp tiền qua ngân hàng của người dùng</p>
                        ...
                        <table class="table table-hover table-borderless align-middle mb-0 text-nowrap w-100">
                            <thead class="bg-light-subtle text-muted">
                                <tr>
                                    ...
                                    <th class="text-uppercase small">Mã giao dịch</th>
                                    ...
                                    <th class="text-uppercase small">Nội dung CK</th>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($deposit->bankAccount): ?>
                                                <?php echo e($deposit->bankAccount->bank_name); ?>
                                        ...
                                        <td>
                                            <?php if($deposit->bankAccount): ?>
                                                <?php echo e($deposit->bankAccount->account_number); ?>
                                        ...
                                        <td><?php echo e($deposit->transaction_content); ?></td>
                                        <td>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\history\bank-deposits.blade.php ENDPATH**/ ?>