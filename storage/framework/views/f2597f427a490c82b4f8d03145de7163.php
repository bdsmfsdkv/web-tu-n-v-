<?php $__env->startSection('title', 'Quản lý danh mục mẹ'); ?>
    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                ...
                <div class="page-btn">
                    <a href="<?php echo e(route('admin.game-groups.create')); ?>" class="btn btn-success">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-bolds"><?php echo e($group->name); ?></td>
                                        <td><?php echo e($group->order); ?></td>
                                        <td><span
                                                class="badge <?php echo e($group->active ? 'bg-lightgreen' : 'bg-lightred'); ?>"><?php echo e($group->active ? 'Hoạt động' : 'Đã ẩn'); ?></span>
                                        </td>
                                        <td><?php echo e($group->created_at->format('d/m/Y')); ?></td>
                                        <td>
                                            <a class="me-3" href="<?php echo e(route('admin.game-groups.edit', $group->id)); ?>">
                                                <i class="ti ti-edit fs-5 text-primary"></i>
                                            </a>
                                            <a class="me-3 confirm-delete" href="javascript:void(0);" data-bs-toggle="modal"
                                                data-bs-target="#deleteModal" data-id="<?php echo e($group->id); ?>">
...
<?php $component = App\View\Components\ModalConfirmDelete::resolve(['message' => 'Bạn có chắc chắn muốn xóa danh mục mẹ này không? Tất cả dữ liệu có liên quan đến danh mục mẹ này sẽ
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views/admin/game-groups/index.blade.php ENDPATH**/ ?>