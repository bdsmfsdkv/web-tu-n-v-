    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">Lịch sử giao dịch tiền</h2>
                <p class="text-muted">Xem tất cả lịch sử giao dịch tiền của hệ thống</p>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views/admin/history/transactions.blade.php ENDPATH**/ ?>