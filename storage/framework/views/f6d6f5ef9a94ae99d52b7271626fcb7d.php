<?php $__env->startSection('title', 'Lịch sử rút tiền'); ?>
    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">Lịch sử rút tiền</h2>
                <p class="text-muted">Xem và quản lý yêu cầu rút tiền của người dùng</p>
                        ...
                        <table class="table table-hover table-borderless align-middle mb-0 text-nowrap w-100">
                            <thead class="bg-light-subtle text-muted">
                                <tr>
                                    ...
                                    <th class="text-uppercase small">Ghi chú người dùng</th>
                                    <th class="text-uppercase small">Ghi chú admin</th>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $withdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdrawal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($withdrawal->user->username); ?></td>
                                        <td><?php echo e(number_format($withdrawal->amount)); ?> đ</td>
                                        <td><?php echo e($withdrawal->user_note ?? 'Không có'); ?></td>
                                        <td><?php echo e($withdrawal->admin_note ?? 'Không có'); ?></td>
                                        <td>
                                            ...
                                            <?php if($withdrawal->status === 'processing'): ?>
                                                <div class="d-flex">
                                                    <button type="button" class="btn btn-sm btn-success me-2"
                                                        ...
                                                        data-bs-target="#successModal<?php echo e($withdrawal->id); ?>">
                                                        Duyệt
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#errorModal<?php echo e($withdrawal->id); ?>">
                                                        Từ chối
                                                    </button>
                                                </div>
                                                ...
                                                <div class="modal fade" id="successModal<?php echo e($withdrawal->id); ?>"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-">
                                                            ...
                                                            <form
                                                                action="<?php echo e(route('admin.withdrawals.approve', $withdrawal)); ?>"
                                                                method="POST">
                                                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="modal fade" id="errorModal<?php echo e($withdrawal->id); ?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-">
                                                            ...
                                                            <form
                                                                action="<?php echo e(route('admin.withdrawals.reject', $withdrawal)); ?>"
                                                                method="POST">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\history\money-withdrawal-history.blade.php ENDPATH**/ ?>