...
unset($__errorArgs, $__bag); ?>">
                                        <option value="leveling" <?php echo e(old('type') == 'leveling' ? 'selected' : ''); ?>>Cày thuê
                                        </option>
                                        <option value="gold" <?php echo e(old('type') == 'gold' ? 'selected' : ''); ?> disabled>Bán
                                            vàng (Chưa
                                            phát triển)
                                        </option>
                                        <option value="gem" <?php echo e(old('type') == 'gem' ? 'selected' : ''); ?> disabled>Bán
                                            ngọc (Chưa
                                            phát triển)
                                        </option>
...
unset($__errorArgs, $__bag); ?>" rows="4" placeholder="Mô tả chi tiết dịch vụ..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" accept="image/*" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;" onchange="previewImage(this, 'preview-svc-thumb')">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\admin\services\create.blade.php ENDPATH**/ ?>