...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.bank-accounts.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="Vietcombank"
                                            <?php echo e(old('bank_name') == 'Vietcombank' ? 'selected' : ''); ?>>Vietcombank</option>
                                        <option value="VietinBank" <?php echo e(old('bank_name') == 'VietinBank' ? 'selected' : ''); ?>>
                                            VietinBank</option>
                                        <option value="BIDV" <?php echo e(old('bank_name') == 'BIDV' ? 'selected' : ''); ?>>BIDV
                                        </option>
                                        <option value="Techcombank"
                                            <?php echo e(old('bank_name') == 'Techcombank' ? 'selected' : ''); ?>>Techcombank</option>
                                        <option value="Sacombank" <?php echo e(old('bank_name') == 'Sacombank' ? 'selected' : ''); ?>>
                                            Sacombank</option>
                                        <option value="MBBank" <?php echo e(old('bank_name') == 'MBBank' ? 'selected' : ''); ?>>MBBank
                                        </option>
                                        <option value="ACB" <?php echo e(old('bank_name') == 'ACB' ? 'selected' : ''); ?>>ACB
                                        </option>
                                        <option value="VPBank" <?php echo e(old('bank_name') == 'VPBank' ? 'selected' : ''); ?>>VPBank
                                        </option>
                                        <option value="Agribank" <?php echo e(old('bank_name') == 'Agribank' ? 'selected' : ''); ?>>
                                            Agribank</option>
                                        <option value="TPBank" <?php echo e(old('bank_name') == 'TPBank' ? 'selected' : ''); ?>>TPBank
                                        </option>
                                        <option value="HDBank" <?php echo e(old('bank_name') == 'HDBank' ? 'selected' : ''); ?>>HDBank
                                        </option>
                                        <option value="VIB" <?php echo e(old('bank_name') == 'VIB' ? 'selected' : ''); ?>>VIB
                                        </option>
                                        <option value="MSB" <?php echo e(old('bank_name') == 'MSB' ? 'selected' : ''); ?>>MSB
                                        </option>
                                        <option value="OCB" <?php echo e(old('bank_name') == 'OCB' ? 'selected' : ''); ?>>OCB
                                        </option>
                                        <option value="Eximbank" <?php echo e(old('bank_name') == 'Eximbank' ? 'selected' : ''); ?>>
                                            Eximbank</option>
                                        <option value="SHB" <?php echo e(old('bank_name') == 'SHB' ? 'selected' : ''); ?>>SHB
                                        </option>
                                        <option value="SeABank" <?php echo e(old('bank_name') == 'SeABank' ? 'selected' : ''); ?>>
                                            SeABank</option>
                                        <option value="NamABank" <?php echo e(old('bank_name') == 'NamABank' ? 'selected' : ''); ?>>
                                            NamABank</option>
                                        <option value="KienLongBank"
                                            <?php echo e(old('bank_name') == 'KienLongBank' ? 'selected' : ''); ?>>KienLongBank
                                        </option>
                                        <option value="PGBank" <?php echo e(old('bank_name') == 'PGBank' ? 'selected' : ''); ?>>PGBank
                                        </option>
                                        <option value="ABBank" <?php echo e(old('bank_name') == 'ABBank' ? 'selected' : ''); ?>>ABBank
                                        </option>
                                        <option value="LPBank" <?php echo e(old('bank_name') == 'LPBank' ? 'selected' : ''); ?>>LPBank
                                        </option>
                                        <option value="VietABank" <?php echo e(old('bank_name') == 'VietABank' ? 'selected' : ''); ?>>
                                            VietABank</option>
                                        <option value="VIETBANK" <?php echo e(old('bank_name') == 'VIETBANK' ? 'selected' : ''); ?>>
                                            VIETBANK</option>
                                        <option value="BACABANK" <?php echo e(old('bank_name') == 'BACABANK' ? 'selected' : ''); ?>>
                                            BACABANK</option>
                                        <option value="BVBank" <?php echo e(old('bank_name') == 'BVBank' ? 'selected' : ''); ?>>BVBank
                                        </option>
                                        <option value="NHQUOCDAN" <?php echo e(old('bank_name') == 'NHQUOCDAN' ? 'selected' : ''); ?>>
                                            Ngân hàng Quốc Dân</option>
                                        <option value="PBVN" <?php echo e(old('bank_name') == 'PBVN' ? 'selected' : ''); ?>>Public
                                            Bank Vietnam</option>
                                        <option value="ShinhanBank"
                                            <?php echo e(old('bank_name') == 'ShinhanBank' ? 'selected' : ''); ?>>Shinhan Bank</option>
                                        <option value="WOORIVN" <?php echo e(old('bank_name') == 'WOORIVN' ? 'selected' : ''); ?>>Woori
                                            Bank Vietnam</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="prefix" value="<?php echo e(old('prefix', 'naptien')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="note" placeholder="Nhập ghi chú (nếu có)"><?php echo e(old('note')); ?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mb-3">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\bank-accounts\create.blade.php ENDPATH**/ ?>