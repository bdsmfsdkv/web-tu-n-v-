    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">Lịch sử nạp thẻ cào</h2>
                <p class="text-muted">Xem tất cả lịch sử nạp thẻ cào của người dùng</p>
                        ...
                        <table class="table table-hover table-borderless align-middle mb-0 text-nowrap w-100">
                            <thead class="bg-light-subtle text-muted">
                                <tr>
                                    ...
                                    <th class="text-uppercase small">Người nạp</th>
                                    <th class="text-uppercase small">Nhà mạng</th>
                                    <th class="text-uppercase small">Mệnh giá</th>
                                    <th class="text-uppercase small">Thực nhận</th>
                                    <th class="text-uppercase small">Mã thẻ</th>
                                    <th class="text-uppercase small">Serial</th>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('admin.users.show', $deposit->user_id)); ?>">
                                                <?php echo e($deposit->user->username ?? 'N/A'); ?>

                                            </a>
                                        </td>
                                        <td>
                                            <span class="text-uppercase"><?php echo e($deposit->telco); ?></span>
                                        </td>
                                        <td><?php echo e(number_format($deposit->amount)); ?> đ</td>
                                        <td><?php echo e(number_format($deposit->received_amount)); ?> đ</td>
                                        <td>
                                            <span
                                                class="text-monospace"><?php echo e(substr($deposit->pin, 0, 4)); ?>****<?php echo e(substr($deposit->pin, -4)); ?></span>
                                        </td>
                                        <td>
                                            <span
                                                class="text-monospace"><?php echo e(substr($deposit->serial, 0, 4)); ?>****<?php echo e(substr($deposit->serial, -4)); ?></span>
                                        </td>
                                        <td>
                                            ...
                                            <?php elseif($deposit->status === 'error'): ?>
                                                <span class="badge bg-danger">Lỗi thẻ</span>
                                            <?php else: ?>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\history\card-deposits.blade.php ENDPATH**/ ?>