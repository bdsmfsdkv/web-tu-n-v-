...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('admin.usdt-accounts.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="binance" <?php echo e(old('type') == 'binance' ? 'selected' : ''); ?>>Binance Pay</option>
                                <option value="trc20" <?php echo e(old('type') == 'trc20' ? 'selected' : ''); ?>>Ví TRC20 / BEP20</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" placeholder="VD: Binance, Ví TRC20" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('wallet_address')); ?>" placeholder="VD: TPj..." required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('qr_image')); ?>" placeholder="VD: https://imgur.com/xxx.png">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('api_token')); ?>" placeholder="VD: 39D6670A..." required>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views/admin/usdt-accounts/create.blade.php ENDPATH**/ ?>