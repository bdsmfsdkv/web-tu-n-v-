    ...
    <div class="nav-container">
        <a href="/" class="nav-brand" aria-label="Trang chủ">
            <?php if(config_get('site_logo')): ?>
                <img src="<?php echo e(asset(config_get('site_logo'))); ?>" alt="<?php echo e(config_get('site_name')); ?>">
            <?php else: ?>
        ...
        <ul class="nav-links" id="navLinks">
            <li class="nav-offcanvas-header">
                <?php if(Auth::check()): ?>
                    <div class="mobile-drawer-user">
                        <div class="mobile-drawer-avatar"><?php echo e(strtoupper(substr(Auth::user()->username, 0, 1))); ?></div>
                        <div class="mobile-drawer-info">
                            <div class="mobile-drawer-name"><?php echo e(Auth::user()->username); ?></div>
                            <div class="mobile-drawer-balance"><?php echo e(number_format(Auth::user()->balance)); ?>đ</div>
                        </div>
                    </div>
                <?php else: ?>
            ...
            <?php if(auth()->guard()->guest()): ?>
                <li class="mobile-auth-banner">
                    <div class="mobile-auth-buttons">
                        <a href="<?php echo e(route('login')); ?>" class="btn-mobile-login">
                            <span class="iconify" data-icon="ant-design:login-outlined"></span> Đăng Nhập
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="btn-mobile-reg">
                                ...
                                <div class="mega-menu-list">
                                    <?php $__empty_1 = true; $__currentLoopData = $navCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <a href="<?php echo e(route('category.index', ['slug' => $cat->slug])); ?>" class="mega-menu-item">
                                            ...
                                            <?php endif; ?>
                                            <span class="mega-item-info"><span class="mega-item-name"><?php echo e($cat->name); ?></span></span>
                                        </a>
                ...
                <div class="mega-menu deposit-mega-menu">
                    <div class="mega-menu-container">
                        <div class="deposit-menu-grid">
                            <a href="<?php echo e(route('profile.deposit-card')); ?>" class="mega-menu-item"><span class="mega-menu-icon-fallback" style="background:#fef2f2;color:#dc2626;"><i class="fa-solid fa-credit-card"></i></span><span class="mega-item-info"><span class="mega-item-name">Nạp thẻ cào</span></span></a>
                            <a href="<?php echo e(route('profile.deposit-atm')); ?>" class="mega-menu-item"><span class="mega-menu-icon-fallback" style="background:#eff6ff;color:#2563eb;"><i class="fa-solid fa-building-columns"></i></span><span class="mega-item-info"><span class="mega-item-name">Ngân hàng / QR</span></span></a>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <li>
                <a href="<?php echo e(route('profile.affiliate')); ?>" class="nav-link-item <?php echo e(request()->routeIs('profile.affiliate') ? 'active' : ''); ?>">
                ...
                <div class="nav-avatar-wrapper" id="avatarWrapper">
                    <div class="nav-user-profile" onclick="toggleAvatarMenu()" title="<?php echo e(Auth::user()->username); ?>">
                        <div class="nav-user-info">
                            ...
                            <div class="nav-user-balance"><?php echo e(number_format(Auth::user()->balance)); ?>đ</div>
                        </div>
                    ...
                    <div class="avatar-dropdown" id="avatarDropdown">
                        <div class="dropdown-user-card">
                            <div class="dropdown-user-header">
                                <div class="dropdown-user-avatar"><?php echo e(strtoupper(substr(Auth::user()->username, 0, 1))); ?></div>
                            ...
                            <div class="dropdown-balance-box">
                                ...
                                <a href="<?php echo e(route('profile.deposit-card')); ?>" class="dropdown-btn-deposit"><i class="fa-solid fa-plus"></i> Nạp Ngay</a>
                            </div>
                        </div>
                        ...
                        <div class="dropdown-menu-links">
                            ...
                            <a href="<?php echo e(route('profile.deposit-card')); ?>" class="dropdown-item"><span class="dropdown-item-icon"><span class="iconify" data-icon="ant-design:wallet-outlined"></span></span><span>Nạp Tiền Vào Ví</span></a>
                            <a href="<?php echo e(route('profile.transaction-history')); ?>" class="dropdown-item"><span class="dropdown-item-icon"><span class="iconify" data-icon="ant-design:history-outlined"></span></span><span>Lịch Sử Giao Dịch</span></a>
                            <a href="<?php echo e(route('profile.purchased-accounts')); ?>" class="dropdown-item"><span class="dropdown-item-icon"><span class="iconify" data-icon="ant-design:shopping-bag-outlined"></span></span><span>Tài Khoản Đã Mua</span></a>
                            <a href="<?php echo e(route('profile.affiliate')); ?>" class="dropdown-item"><span class="dropdown-item-icon"><span class="iconify" data-icon="ant-design:share-alt-outlined"></span></span><span>Tiếp Thị Liên Kết</span></a>
                            <?php if(Auth::user()->role == 'admin'): ?>
                                <a href="<?php echo e(route('admin.index')); ?>" class="dropdown-item dropdown-admin"><span class="dropdown-item-icon"><span class="iconify" data-icon="ant-design:dashboard-outlined"></span></span><span>Quản Trị Admin</span></a>
                            <?php endif; ?>
                        </div>
