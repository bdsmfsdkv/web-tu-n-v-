...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($service->id); ?>"
                                                <?php echo e(old('game_service_id', $package->game_service_id) == $service->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="amount" value="<?php echo e(old('amount', $package->amount ?? 0)); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="price" value="<?php echo e(old('price', $package->price)); ?>"
                            ...
                            <div class="col-lg-6 col-sm-6 col-12" id="estimated-time-group">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="estimated_time"
                                        value="<?php echo e(old('estimated_time', $package->estimated_time)); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-12 d-flex align-items-center mb-3">
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" <?php echo e(old('active', $package->active) == '1' || $package->active === 1 || $package->active === true ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" rows="4"
                                        placeholder="Mô tả chi tiết về gói dịch vụ"><?php echo e(old('description', $package->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-12">
                                ...
                                <a href="<?php echo e(route('admin.packages.service', $package->game_service_id)); ?>"
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SHOP BÁN ACC GAME V1\resources\views\admin\packages\edit.blade.php ENDPATH**/ ?>