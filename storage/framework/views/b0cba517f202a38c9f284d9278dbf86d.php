                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if($item->icon): ?>
                                            <img src="<?php echo e(asset($item->icon)); ?>" alt="<?php echo e($item->name); ?>" style="width: 40px; height: 40px; object-fit: contain;" class="rounded border shadow-sm">
                                        <?php else: ?>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views\admin\reward-items\index.blade.php ENDPATH**/ ?>