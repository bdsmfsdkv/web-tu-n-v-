...
class ConfigSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $siteName = 'Shop Game Uy Tín';
        $siteDescription = 'Shop Game Uy Tín cung cấp tài khoản game chính hãng, giá tốt nhất thị trường. Giao dịch an toàn, nhanh chóng và bảo mật';
        $contactEmail = '';
        $contactPhone = '';
        ...
        $configs = [
            ...
            'login_social.google.client_id' => config('services.google.client_id', ''),
            'login_social.google.client_secret' => config('services.google.client_secret', ''),
            'login_social.google.redirect' => config('services.google.redirect', ''),

            'login_social.facebook.active' => '1',
            'login_social.facebook.client_id' => config('services.facebook.client_id', ''),
            'login_social.facebook.client_secret' => config('services.facebook.client_secret', ''),
            'login_social.facebook.redirect' => config('services.facebook.redirect', ''),                                               
        ];
