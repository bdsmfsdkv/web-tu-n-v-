...
<nav class="navbar">
    <div class="nav-container">
        <a href="/" class="nav-brand">
            <img src="{{ config_get('site_logo') }}" alt="{{ config_get('site_name') }}" width="120" height="32" style="height:32px; width:auto;">
        </a>
        ...
        <ul class="nav-links" id="navLinks">
            <li class="nav-offcanvas-header">
                <a href="/" class="nav-brand">
                    <img src="{{ config_get('site_logo') }}" alt="{{ config_get('site_name') }}" width="105" height="28" style="height:28px; width:auto;">
                </a>
