            ...
            <div class="ecom-box ecom-gallery-box">
                <div class="ecom-gallery-inner">
                    <div class="ecom-thumbs-vertical">
                        <img src="{{ $displayImage }}" class="ecom-thumb" onclick="changeMainImage('{{ $displayImage }}', 0)" alt="Thumb">
                    </div>
                    <div class="ecom-main-img-wrapper" style="cursor: pointer;" onclick="openLightbox()">
                        <img src="{{ $displayImage }}" id="ecom-main-img" class="ecom-main-img" alt="Main Image">
                    ...
                    <div id="lightbox-gallery" style="display: none;">
                        <a href="{{ $displayImage }}" class="detail__images-link">
                            <img src="{{ $displayImage }}" alt="Hình ảnh tài khoản">
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    @foreach ($relatedAccounts as $related)
                        ...
                        <div class="account-card" style="border: 1px solid var(--border-color); border-radius: 8px; overflow: hidden; display: flex; flex-direction: column; background: var(--box-bg);">
                            <div class="account-media" style="position: relative;">
                                <a href="{{ route('random.account.show', ['id' => $related->id]) }}">
                                    <img src="{{ $relImg }}" alt="Account" style="width: 100%; height: 120px; object-fit: cover;">
                                </a>
                            ...
                            <div class="account-info" style="padding: 10px; flex-grow: 1; text-align: center;">
                                ...
                                <a href="{{ route('random.account.show', ['id' => $related->id]) }}" class="ecom-btn ecom-btn-outline" style="width: 100%; padding: 6px; font-size: 0.85rem;">XEM CHI TIẾT</a>
                            </div>
                        </div>
                    @endforeach
                </div>
