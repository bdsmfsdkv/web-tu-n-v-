                ...
                @foreach($newsList as $news)
                    <a href="{{ route('news.show', $news->slug) }}" class="news-card">
                        ...
                        <div class="news-content">
                            ...
                            <div class="news-meta">
                                <span class="date"><span class="iconify" data-icon="ant-design:calendar-outlined"></span> {{ $news->created_at->format('d/m/Y') }}</span>
                                <span class="views"><span class="iconify" data-icon="ant-design:eye-outlined"></span> {{ number_format($news->views) }}</span>
                            </div>
                        </div>
                    </a>
                @endforeach
