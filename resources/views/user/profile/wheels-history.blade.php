                                            ...
                                            <tbody>
                                                @forelse($wheelHistories as $history)
                                                    <tr>
                                                        ...
                                                        <td>{{ $history->spin_count }}x</td>
                                                        <td class="amount text-danger">-{{ number_format($history->total_cost) }} VND</td>
                                                        <td>
                                                            @php
                                                            ...
                                                            @endphp
                                                            <span style="display:inline-block; padding: 4px 14px; background: {{ $bg }}; color: {{ $color }}; border: 1px solid {{ $border }}; border-radius: 20px; font-size: 0.82rem; font-weight: 700; white-space: nowrap;">{{ $desc }}</span>
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn-view-details view-details" data-id="{{ $history->id }}" title="Xem chi tiết">
