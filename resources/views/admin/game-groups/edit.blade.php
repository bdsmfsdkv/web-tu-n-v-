                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <div class="image-upload" style="position: relative; border: 1px dashed #4680ff; background: rgba(70, 128, 255, 0.05); padding: 20px; border-radius: 8px; text-align: center;">
                                        <input type="file" name="thumbnail" class="form-control @error('thumbnail') is-invalid @enderror" accept="image/*" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer;" onchange="previewImage(this, 'preview-gg-edit-thumb')">
                                        <div class="image-uploads mt-2" style="pointer-events: none;">
                                            @if($gameGroup->thumbnail)
                                                <div class="existing-thumb-wrapper d-inline-block" style="position: relative; display: inline-block; pointer-events: auto;">
                                                    <img id="preview-gg-edit-thumb" src="{{ asset($gameGroup->thumbnail) }}" alt="img" style="max-height: 80px; object-fit: contain; margin-bottom: 10px; border-radius: 4px;">
                                                    <button type="button"
                                                        class="btn btn-danger remove-existing-thumb"
                                                        title="Xoá ảnh này"
                                                        aria-label="Xoá ảnh này"
                                                        onclick="removeExistingGroupThumb(this)"
...
@push('scripts')
    <script>
        function removeExistingGroupThumb(button) {
