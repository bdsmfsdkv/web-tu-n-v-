    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                ...
                <div class="page-btn">
                    <a href="{{ route('admin.discount-codes.create') }}" class="btn btn-success">
                ...
                <form class="p-3 bg-auto-subtle border-bottom filter-form" method="GET">
                    ...
                    <div class="table-responsive table-border-style">
                        <table class="table table-hover table-borderless align-middle mb-0 text-nowrap w-100">
                            ...
                            <tbody>
                                @forelse($discountCodes as $key => $discountCode)
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span
                                                class="badge {{ $discountCode->is_active === '1' ? 'bg-lightgreen' : 'bg-lightred' }}">
