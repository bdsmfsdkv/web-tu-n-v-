                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($usage->discountCode)
                                                <span class="badge bg-success">{{ $usage->discountCode->code }}</span>
                                            @else
                                        ...
                                        <td>
                                            @if ($usage->discountCode)
                                                @if ($usage->discountCode->type === 'percent')
                                                    <span
                                                        class="badge bg-warning">{{ $usage->discountCode->value }}%</span>
                                                @else
                                                    <span
                                                        class="badge bg-lightblue">{{ number_format($usage->discountCode->value) }}đ</span>
                                                @endif
                                            @else
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="badge bg-success">{{ $usage->context }}</span>
                                            @endif
                                            #{{ $usage->item_id }}
                                        </td>
