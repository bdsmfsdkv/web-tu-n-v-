                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <select name="category_type" class="form-select @error('category_type') is-invalid @enderror">
                                        <option value="random" {{ old('category_type', $category->category_type ?? 'random') == 'random' ? 'selected' : '' }}>
                                            Loại 1: Mua ngẫu nhiên (Chọn số lượng mua random)
                                        </option>
                                        <option value="account_list" {{ old('category_type', $category->category_type) == 'account_list' ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="custom_stock_count" class="form-control" value="{{ old('custom_stock_count', $category->custom_stock_count) }}" placeholder="Để trống sẽ tự đếm theo số acc có sẵn thực tế">
                            ...
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="custom_sold_count" class="form-control" value="{{ old('custom_sold_count', $category->custom_sold_count) }}" placeholder="Để trống sẽ tự đếm theo số acc đã bán thực tế">
                                    ...
                                    <div class="image-upload" style="position: relative; border: 1px dashed #ffb822; background: rgba(255, 184, 34, 0.05); padding: 20px; border-radius: 8px; text-align: center;">
                                        ...
                                        <div class="image-uploads mt-2" style="pointer-events: none;">
                                            @if($category->tag_image)
                                                <div class="existing-tag-wrapper d-inline-block" style="position: relative; display: inline-block; pointer-events: auto;">
