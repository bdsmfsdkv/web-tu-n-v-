    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                ...
                <div class="page-btn">
                    <a href="{{ route('admin.lucky-wheels.create') }}" class="btn btn-success">
            ...
            <div class="card overflow-hidden shadow-sm border border-dashed">
                <div class="card-header border-bottom-0 pt-4 pb-0 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.lucky-wheels.history') }}" class="btn btn-sm btn-light-info text-info">
