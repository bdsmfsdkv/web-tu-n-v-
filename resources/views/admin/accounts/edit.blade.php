                                        ...
                                        @if(is_array($details) && count($details) > 0)
                                            @foreach($details as $index => $detail)
                                                <div class="row align-items-center mb-2 attribute-row">
                                                    <div class="col-5">
                                                        <input type="text" name="details[{{ $index }}][key]" class="form-control" value="{{ $detail['key'] ?? '' }}" placeholder="Tên thuộc tính (VD: Rank)" required>
                                                    </div>
                                                    <div class="col-5">
                                                        <input type="text" name="details[{{ $index }}][value]" class="form-control" value="{{ $detail['value'] ?? '' }}" placeholder="Giá trị (VD: Kim Cương)" required>
                                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="image-upload" style="position: relative; border: 1px dashed #4680ff; background: rgba(70, 128, 255, 0.05); padding: 20px; border-radius: 8px; text-align: center;">
                                        ...
                                        <div class="image-uploads mt-2">
                                            @if($account->thumb)
                                                <img src="{{ asset($account->thumb) }}" alt="img" style="max-height: 80px; object-fit: contain; margin-bottom: 10px; border-radius: 4px;">
