    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">Cài đặt mạng xã hội & thông báo</h2>
                <p class="text-muted">Quản lý liên kết mạng xã hội và popup thông báo của website</p>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="col-lg-12">
                                <div class="card p-3 mb-3 border bg-light">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="floating_contact_enabled_page" name="floating_contact_enabled" value="1" {{ !empty($configs['floating_contact_enabled']) ? 'checked' : '' }}>
                                        <label class="form-check-label fw-bold text-dark" for="floating_contact_enabled_page">
