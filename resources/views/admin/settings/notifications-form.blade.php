    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">{{ isset($notification) ? 'Chỉnh sửa thông báo' : 'Thêm thông báo mới' }}</h2>
                <p class="text-muted">{{ isset($notification) ? 'Cập nhật thông tin thông báo' : 'Tạo thông báo mới hiển thị trên trang chủ' }}
                    </p>
            </div>
        </div>
    </div>
                    ...
                    <form
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <a href="{{ route('admin.settings.notifications') }}" class="btn btn-secondary">Hủy bỏ</a>
                            </div>
                        </div>
                    </form>
                </div>
