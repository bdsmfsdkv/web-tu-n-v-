    ...
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="page-header-title">
                <h2 class="mb-0">Cấu hình đăng nhập</h2>
                <p class="text-muted">Quản lý các cấu hình phương thức đăng nhập</p>
            </div>
        </div>
    </div>
</div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <div class="form-check form-switch mt-2">
                                                <input class="form-check-input" type="checkbox" id="google_active" name="google_active" value="1" {{ old('google_active', $configs['google_active']) ? 'checked' : '' }}>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <div class="form-check form-switch mt-2">
                                                <input class="form-check-input" type="checkbox" id="facebook_active" name="facebook_active" value="1" {{ old('facebook_active', $configs['facebook_active']) ? 'checked' : '' }}>
