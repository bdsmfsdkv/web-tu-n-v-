                ...
                <div class="card-body">
                    <form action="{{ route('admin.settings.social.update') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4"><div class="mb-3"><label class="form-label">Số giờ ẩn</label><input type="number" name="welcome_modal_snooze_hours" class="form-control" value="{{ old('welcome_modal_snooze_hours', $configs['welcome_modal_snooze_hours']) }}" min="0.1" max="720" step="0.1" required></div></div>
                            <div class="col-lg-4"><div class="mb-3"><label class="form-label">Text nút đóng</label><input type="text" name="welcome_modal_close_text" class="form-control" value="{{ old('welcome_modal_close_text', $configs['welcome_modal_close_text']) }}" maxlength="50" required></div></div>
                            <div class="col-lg-4"><div class="mb-3"><label class="form-label">Text nút ẩn</label><input type="text" name="welcome_modal_snooze_text" class="form-control" value="{{ old('welcome_modal_snooze_text', $configs['welcome_modal_snooze_text']) }}" maxlength="100" required><small class="form-text text-muted">Dùng <code>:hours</code> để hiện số giờ.</small></div></div>
                            <div class="col-lg-12">
